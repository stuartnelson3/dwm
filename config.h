...
static const char *fonts[]          = { "Consolas:style=Bold:pixelsize=14:antialias=true:autohint=true" };
static const char dmenufont[]       = "Consolas:style=Bold:pixelsize=14:antialias=true:autohint=true";
